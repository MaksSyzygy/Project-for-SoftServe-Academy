...
namespace Diplom
{
    class ClientAllData
    {
        ...
        public ClientAllData(int clientID, string name, string surname, string birthday, string phone, int infoID, decimal balance, decimal credit, decimal deposit, string password, string managerName, string managerSurname, string managerPhone)
        {
        ...
        public List<ClientAllData> AddAllClientInfo()
        {
            ...
            {
                list.Add(new ClientAllData(item.ClientID, item.ClientName, item.ClientSurname, item.ClientBirthday, item.ClientPhone, item.InfoID, item.Balance, item.Credit, item.Deposit, item.Password, item.ManagerName, item.ManagerSurname, item.ManagerPhone));
            }
